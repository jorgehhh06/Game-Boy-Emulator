...
*/
public class Instructions_Enum {
    public enum AddrMode {
        ...
        /* Registro de 16 bits desde Registro de 16 bits: (ej: LD SP, HL) */
        AM_R_R16,

        /* Registro desde Memoria (C): Lee de $FF00 + registro C al registro A (ej: LD A, (C)) */
        AM_R_MC,

        /* Memoria (C) desde Registro: Escribe el registro A en $FF00 + registro C (ej: LD (C), A) */
        AM_MC_R
    }
    ...
    public enum InType {
        ...
        */
        ...
        IN_HALT, // Halt: Detiene la CPU hasta que ocurra una interrupción
